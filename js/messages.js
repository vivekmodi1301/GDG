var messages = {
  ...
  labelFooter: {
    'en': 'CSS Ninja Challenge is created by',
    'he': 'CSS Ninja Challenge נוצר על ידי',
    'ro': 'CSS Ninja Challenge este creat de',
    'sr': 'CSS Ninja Challenge је направио',
    'bs': 'CSS Ninja Challenge je napravio',
    'hr': 'CSS Ninja Challenge je stvorio',
    'bg': 'CSS Ninja Challenge е създадена от',
    'de': 'CSS Ninja Challenge wurde gemacht von',
    'fr': 'CSS Ninja Challenge est créé par',
    'pt-br': 'CSS Ninja Challenge foi criado por',
    'es': 'CSS Ninja Challenge es una creación de',
    'ru': 'Игра CSS Ninja Challenge создана',
    'fa': 'قورباغه فلکس باکس ساخته شده توسط',
    'zh-cn': 'CSS Ninja Challenge的作者是',
    'zh-tw': 'CSS Ninja Challenge的作者是',
    'tr': 'CSS Ninja Challenge\'nin yaratıcısı:',
    'az': 'CSS Ninja Challenge\'nin qurucusu:',
    'it': 'CSS Ninja Challenge è stato creato da',
    'ko': 'CSS Ninja Challenge는 다음에 의해 개발되었습니다',
    'lt': 'CSS Ninja Challenge kūrėjas',
    'vi': 'CSS Ninja Challenge được tạo ra bởi',
    'pl': 'CSS Ninja Challenge jest wytworem',
    'cs': 'CSS Ninja Challenge vytvořil',
    'ja': 'CSS Ninja Challenge is created by',
    'hu': 'A CSS Ninja Challenge-t készítette',
    'eo': 'CSS Ninja Challenge far',
    'sv': 'CSS Ninja Challenge skapades av',
    'uk': 'Гру CSS Ninja Challenge створено',
    'hi': 'CSS Ninja Challenge के निर्माणकर्ता ',
    'gj': 'CSS Ninja Challenge ના નિર્માણકર્તા ',
    'nl': 'CSS Ninja Challenge is gemaakt door',
    'ta': 'CSS Ninja Challenge உருவாக்கியவர்',
    'te': 'CSS Ninja Challenge చేసిన వారు',
    'ml': 'CSS Ninja Challenge സൃഷ്ടിച്ചത്',
    'el': 'Το CSS Ninja Challenge δημιουργήθηκε από',
    'mk': 'CSS Ninja Challenge е создадено од',
    'lv': 'CSS Ninja Challenge autori ir',
    'id': 'CSS Ninja Challenge dibuat oleh',
    'ar': 'تم انشاء فروغي فلكسبكس بواسطة',
    'ca': 'CSS Ninja Challenge és una creació de',
    'da': 'CSS Ninja Challenge er skabt af',
    'et': 'CSS Ninja Challenge on looja on',
    'fi': 'CSS Ninja Challengen on tehnyt',
    'gl': 'CSS Ninja Challenge creouno',
    'th': 'CSS Ninja Challenge ถูกสร้างโดย',
    'mn': 'CSS Ninja Challenge is created by',
    'sk': 'CSS Ninja Challenge vytvoril',
    'si': 'Flexbox මැඬියා නිර්මාණය කළේ',
    'bn': 'CSS Ninja Challenge তৈরি করেছেন',
  },
  labelLevel: {
    'en': 'Level',
    'he': 'שלב',
  ...
  title: {
    'en': 'CSS Ninja Challenge - A game for learning CSS flexbox',
    'he': 'CSS Ninja Challenge - משחק ללמידת CSS flexbox',
    'ro': 'CSS Ninja Challenge - Un joc pentru a învăța CSS flexbox',
    'sr': 'CSS Ninja Challenge - Игра за учење CSS flexbox-а',
    'bs': 'CSS Ninja Challenge - Igra za učenje CSS flexbox-a',
    'hr': 'CSS Ninja Challenge - Igra za učenje CSS flexboxa',
    'bg': 'CSS Ninja Challenge - Игра за учене на CSS flexbox',
    'de': 'CSS Ninja Challenge - Ein Spiel, um CSS flexbox zu lernen',
    'fr': 'CSS Ninja Challenge - Un jeu pour apprendre les flexbox CSS',
    'pt-br': 'CSS Ninja Challenge - Um jogo para aprender CSS flexbox',
    'es': 'CSS Ninja Challenge - Un juego para aprender CSS flexbox',
    'ru': 'CSS Ninja Challenge - игра для изучения CSS flexbox',
    'fa': 'قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس',
    'zh-cn': 'CSS Ninja Challenge - 一个用来学CSS flexbox的游戏',
    'zh-tw': 'CSS Ninja Challenge - 一個用來學CSS flexbox的遊戲',
    'tr': 'CSS Ninja Challenge - CSS flexbox için öğretici oyun',
    'az': 'CSS Ninja Challenge - CSS flexbox üçün öyrədici oyun',
    'it': 'CSS Ninja Challenge - Un gioco per imparare CSS flexbox',
    'ko': 'CSS Ninja Challenge - CSS flexbox 속성 배우기 게임',
    'lt': 'CSS Ninja Challenge - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    'vi': 'CSS Ninja Challenge - Một trò chơi để học CSS flexbox',
    'pl': 'CSS Ninja Challenge - Gra wprowadzająca do CSS flexbox"',
    'cs': 'CSS Ninja Challenge - CSS flexbox hrou',
    'ja': 'CSS Ninja Challenge - CSS flexbox学習ゲーム',
    'hu': 'CSS Ninja Challenge - Játékos CSS flexbox tanulás',
    'eo': 'CSS Ninja Challenge - Ludo por lerni CSS flexbox-on',
    'sv': 'CSS Ninja Challenge - Ett spel för att lära sig CSS flexbox',
    'uk': 'CSS Ninja Challenge - гра для вивчення CSS flexbox',
    'hi': 'CSS Ninja Challenge - CSS Flexbox सीखने के लिए एक खेल',
    'gj': 'CSS Ninja Challenge - CSS Flexbox  શીખવા માટેની એક રમત',
    'nl': 'CSS Ninja Challenge - Een spel om CSS flexbox te leren',
    'ta': 'CSS Ninja Challenge - CSS flexbox கற்றல் விளையாட்டு',
    'te': 'CSS Ninja Challenge - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట',
    'ml': 'CSS Ninja Challenge - CSS Flexbox പഠിക്കാം',
    'el': 'CSS Ninja Challenge - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox',
    'mk': 'CSS Ninja Challenge - Игра за учење на CSS flexbox',
    'lv': 'CSS Ninja Challenge - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox',
    'id': 'CSS Ninja Challenge - Sebuah permainan untuk belajar CSS flexbox',
    'ar': 'فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS',
    'ca': 'CSS Ninja Challenge - Un joc per aprendre CSS Flexbox',
    'da': 'CSS Ninja Challenge - Et spil, der lærer dig CSS Flexbox',
    'et': 'CSS Ninja Challenge - Mäng CSS flexbox\'i õppimiseks',
    'fi': 'CSS Ninja Challenge - Peli, jossa opit CSS flexbox -asettelun',
    'gl': 'CSS Ninja Challenge - Un xogo para aprenderes CSS Flexbox',
    'th': 'CSS Ninja Challenge - เกมสำหรับเรียนรู้ CSS Flexbox',
    'mn': 'CSS Ninja Challenge - CSS flexbox-г сурах тоглоом',
    'sk': 'CSS Ninja Challenge - Hra na učenie CSS flexbox',
    'si': 'Flexbox මැඬියා - CSS flexbox ඉගෙනීමේ ක්‍රීඩාවක්',
    'bn': 'CSS Ninja Challenge - CSS flexbox শেখার জন্য একটি খেলা',
  },
  labelReset: {
    'en': 'Reset',
    'he': 'איפוס',
